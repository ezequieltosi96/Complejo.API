...
{
    public class CreateTurnHandler : IRequestHandler<CreateTurnCommand, Guid>
    {
        ...
        private readonly IValidator<CreateTurnCommand> validator;
        ...
        public CreateTurnHandler(ITurnRepository turnRepository, IValidator<CreateTurnCommand> validator, IMapping mapping, IUserService userService, IRequestHandler<CreateClientUserCommand, string> createUserHandler, IClientRepository clientRepository, IRequestHandler<CreateClientCommand, Guid> createClientHandler)
        {
        ...
        public async Task<Guid> Handle(CreateTurnCommand request, CancellationToken cancellationToken)
        {
